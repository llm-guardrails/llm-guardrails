/**
 * Tests for GuardedOpenAI
 */

import { describe, it, expect, beforeEach, vi } from 'vitest';
import { GuardedOpenAI, GuardrailBlockError } from '../GuardedOpenAI';
...
describe('GuardedOpenAI', () => {
  describe('Initialization', () => {
    it('should create instance with default config', () => {
      ...
      expect(client).toBeInstanceOf(GuardedOpenAI);
  ...
  describe('Guardrail Engine Access', () => {
    it('should provide access to guardrail engine', () => {
      const client = new GuardedOpenAI({ apiKey: 'test-key' });
      const engine = client.getGuardrailEngine();
